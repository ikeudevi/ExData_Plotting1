...
#plot3.R File: The zipped household power consumption data was downloaded to a directory, 
...
#
#Similar to plot2; replace Global Active Power with the three Sub_metering variables.
...
#
#Add legend
legend("topright", legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col=c("green","red","blue"),lty=3)
